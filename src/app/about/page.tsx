    ...
    <div className={styles.container} id='about'>
      ...
      <div className={styles.content}>
        <div className={styles.text}>
          ...
          <p>
            At Luxe Timepieces, we believe that a watch is more than just a tool to tell time – it's a work of art, a statement of style, and a companion for life's most important moments. We invite you to explore our collection and discover the perfect timepiece to accompany you on your journey.
          </p>
        </div>
